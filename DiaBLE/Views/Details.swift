            ...
            Form {
                ...
                if app.device != nil && app.device.type == .transmitter(.abbott) || settings.preferredTransmitter == .abbott {
                    ...
                    Section(header: Text("BLE Setup").font(.headline)) {
                        ...
                        HStack {
                            Text("Patch Info")
                            TextField("Patch Info", value: $settings.activeSensorPatchInfo, formatter: HexDataFormatter()).multilineTextAlignment(.trailing).foregroundColor(.blue)
                        }
                        HStack {
                        ...
                        HStack {
                            Text("Unlock Code")
                            TextField("Unlock Code", value: $settings.activeSensorUnlockCode, formatter: NumberFormatter()).keyboardType(.numbersAndPunctuation).multilineTextAlignment(.trailing).foregroundColor(.blue)
                        }
                        HStack {
                            Text("Unlock Count")
                            TextField("Unlock Count", value: $settings.activeSensorUnlockCount, formatter: NumberFormatter()).keyboardType(.numbersAndPunctuation).multilineTextAlignment(.trailing).foregroundColor(.blue)
                        }
