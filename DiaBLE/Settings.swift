...
class Settings: ObservableObject {
    ...
    @Published var activeSensorPatchInfo: PatchInfo = UserDefaults.standard.data(forKey: "activeSensorPatchInfo")! {
        didSet { UserDefaults.standard.set(self.activeSensorPatchInfo, forKey: "activeSensorPatchInfo") }
    }
